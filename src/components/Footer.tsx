...
export function Footer() {
  return (
    <footer className="relative mt-8 border-t border-border/80 bg-[color-mix(in_oklab,var(--surface)_40%,transparent)]">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 mx-auto h-px max-w-3xl bg-gradient-to-r from-transparent via-primary/70 to-transparent"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-16 left-1/2 h-32 w-2/3 -translate-x-1/2 rounded-full bg-primary/10 blur-3xl"
      />
      <div className="container-page relative py-14">
        <div className="grid gap-10 md:grid-cols-[1.4fr_2fr]">
          <div className="max-w-sm">
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              CardVerse is an independent informational platform for discovering digital gift cards
              and selected online offers.
            </p>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-border pt-6 md:flex-row md:items-start md:justify-between md:gap-10">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground md:text-right">
            CardVerse is an independent informational website and is not affiliated with or endorsed
            by any card issuer, game publisher, retailer or service provider unless explicitly
            stated.
          </p>
        </div>
      </div>
